...
#else
            GP_Logger.Log("REWARDS: ", "Given List");
...
#else
            GP_Logger.Log("REWARDS: ", "Get Reward");
...
#else
            GP_Logger.Log("REWARDS: ", "Has Accepted");
...
#else
            GP_Logger.Log("REWARDS: ", "Has Unaccepted");
